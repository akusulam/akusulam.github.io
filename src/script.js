...
const ProfileView = Container({
  ...
  children: [
    Container({
      child: Image.Asset("images/ryujin.jpg", {
        id: "profile-picture",
        opacity: "0.95",
        // size: Size(130, 130),
        width: 130,
    ...
    Container({
      ...
      transition: ".7s",
      child: Text(
        "Perkenalkan nama saya Nourin Alam Adzani. Saya adalah seorang mahasiswa jurusan TI di Universitas Muhammadiyah Yogyakarta, saat ini saya sedang mempelajari bahasa pemrograman untuk mengisi waktu luang.", {
          fontFamily: "Manrope",
          color: Colors.white,
          fontWeight: "100",
          fontSize: 13,
      ...
      children: [
        Container({
          ...
          children: [
            ...
            generateSkillBox("skill-4", "images/Csharp.png", "C#",
              ...
              "www.wikipedia.org/wiki/C_Sharp_(programming_language)"
            ),
            generateSkillBox("skill-5", "images/python.png", "Python", 
            ...
            generateSkillBox("skill-6", "images/dart.png", "Dart", 
            ...
            generateSkillBox("skill-7", "images/html5.png", "HTML", 
...
const SchoolView = Container({
  ...
  children: [
    ...
    Container({
      ...
      width: "100vw",
      children: [
        generateImageBox("images/SD 7.jpg", "SD N Ketanggungan 7", "Saya telah menyelesaikan pendidikan ini pada tahun 2014", "http://sdnketanggungan07.mysch.id/"),
        generateImageBox("images/MTS.jpg", "MTS N  Ketanggungan", "Saya telah menyelesaikan pendidikan ini pada tahun 2017", "http://mtsn1brebes.sch.id/"),
        generateImageBox("images/SMA 1.jpg", "SMA N 1 Bulakamba", "Saya telah menyelesaikan pendidikan ini pada tahun 2020", "http://sman1bulakamba.sch.id/"),
        generateImageBox("images/UMY.jpeg", "Universitas Muhammadiyah Yogyakarta", "Saat ini saya sedang menduduki bangku Kuliah, dan insya allah saya akan lulus pada tahun 2024", "https://www.umy.ac.id/"),
      ]
    })
  ]
});
...
ID("albums-button").onclick = () => {
  ...
  button_submit.onclick = () => {
    ...
    if(usInput && pwInput) {
      if(usInput == "alam" && pwInput == "260402") {
        Alert("Login success");
      } else {
        Alert("Invalid!");
      }
